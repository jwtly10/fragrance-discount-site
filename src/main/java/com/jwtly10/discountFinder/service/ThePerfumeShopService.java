...
public class ThePerfumeShopService implements IStoreService{
    ...
    private Site site = new Site("The Perfume Shop",  "https://www.theperfumeshop.com", "https://media.theperfumeshop.com");
    private String apiUrl = "https://api.theperfumeshop.com/api/v2/tpsgb/search?fields=FULL&searchType=PRODUCT&query=%3Aranking&categoryCode=C101&lang=en_GB&curr=GBP";
    ...
    public CompletableFuture<Collection<Product>> fetchProducts(int page){
